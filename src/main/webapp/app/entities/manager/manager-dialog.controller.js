(function() {
    ...
    ManagerDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'Manager', 'User', 'LawenforceDepartment', 'DoubleRandomResult'];

    function ManagerDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, Manager, User, LawenforceDepartment, DoubleRandomResult) {
        var vm = this;
