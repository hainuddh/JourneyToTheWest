...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "JourneyToTheWest@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "JourneyToTheWest API";

        private String description = "JourneyToTheWest API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "JourneyToTheWest";
